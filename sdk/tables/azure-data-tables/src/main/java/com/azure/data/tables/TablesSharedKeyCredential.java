...
public class TablesSharedKeyCredential {
    ...
    public static com.azure.storage.common.StorageSharedKeyCredential fromConnectionString(String connectionString) {
        ...
        if (!CoreUtils.isNullOrEmpty(accountName) && !CoreUtils.isNullOrEmpty(accountKey)) {
            return new com.azure.storage.common.StorageSharedKeyCredential(accountName, accountKey);
        } else {
